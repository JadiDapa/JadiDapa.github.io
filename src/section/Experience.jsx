    ...
    <section id="experience" className="px-4 lg:px-28 py-5 bg-dark2">
      <div className="container mx-auto flex flex-col items-start md:flex-row my-12 md:my-24">
        <div className="flex flex-col w-full sticky md:top-36 lg:w-1/3 mt-2 md:mt-12 px-8">
          ...
          <a
            href="#project"
            className="mr-auto hover:bg-primary text-primary hover:text-dark2 rounded-md py-2 px-4 border border-primary hover:border-transparent duration-300 flex gap-2 icons-box"
          >
            My Projects
        ...
        <div className="ml-0 md:ml-12 lg:w-2/3 sticky">
          <div className="container mx-auto w-full h-full">
            ...
            <img className="mx-auto -mt-36 md:-mt-36" src={illust} />
          </div>
        </div>
      </div>
    </section>
